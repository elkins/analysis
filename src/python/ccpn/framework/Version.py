...
__dateModified__ = "$dateModified: 2025-04-16 12:56:20 +0100 (Wed, April 16, 2025) $"
...
_previousApplicationVersion = VersionString('3.3.1')
applicationVersion = VersionString('3.3.2')
